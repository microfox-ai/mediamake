...
const presetParams = z.object({
    ...
    particleEffect: z.enum(['assemble', 'disassemble', 'explode', 'pixelate']).default('assemble'),
...
const presetExecution = async (
    ...
    const { trackId, imageUrl, start, duration, revealDuration, particleCount,
        particleSize, particleEffect, assembleFrom, speed, rotation,
