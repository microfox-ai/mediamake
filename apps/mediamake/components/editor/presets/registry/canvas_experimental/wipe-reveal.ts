...
const presetExecution = async (
    ...
    const { trackId, imageUrl, start, duration, revealDuration, revealType, edgeStyle,
        wipeAngle, edgeWaviness, edgeFrequency, backgroundColor, fit,
        burnGlow, burnGlowColor, burnGlowIntensity } = params;
