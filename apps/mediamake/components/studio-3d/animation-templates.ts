...
// ─── Template 1: Cosmic Dance (default) ──────────────────────────────────────
...
export const COSMIC_DANCE: SceneTemplate = {
  ...
  objects: [
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_cd_floor', name: 'Floor', type: 'plane',
      position: [0, -0.01, 0], rotation: [-PI / 2, 0, 0], scale: [12, 12, 1],
      color: '#1a0a2e', roughness: 0.95, metalness: 0,
      castShadow: false, receiveShadow: true,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_cd_knot', name: 'Torus Knot', type: 'torusKnot',
    ...
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_cd_sphere', name: 'Orb', type: 'sphere',
    ...
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_cd_box', name: 'Cube', type: 'box',
    ...
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_cd_ico', name: 'Gem', type: 'icosahedron',
...
export const NEON_PULSE: SceneTemplate = {
  ...
  objects: [
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_np_ico', name: 'Core', type: 'icosahedron',
      position: [0, 1.2, 0], rotation: [0, 0, 0], scale: [0.9, 0.9, 0.9],
      color: '#00ffcc', roughness: 0, metalness: 1,
      emissive: '#00ffcc', emissiveIntensity: 1.2,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_np_ring_x', name: 'Ring X', type: 'torus',
      position: [0, 1.2, 0], rotation: [0, 0, 0], scale: [2, 2, 2],
      color: '#ff00aa', roughness: 0, metalness: 1,
      emissive: '#ff00aa', emissiveIntensity: 0.9,
      opacity: 0.85,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_np_ring_z', name: 'Ring Z', type: 'torus',
      position: [0, 1.2, 0], rotation: [PI / 2, 0, 0], scale: [2, 2, 2],
      color: '#ffdd00', roughness: 0, metalness: 1,
      emissive: '#ffdd00', emissiveIntensity: 0.9,
      opacity: 0.85,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_np_ring_y', name: 'Ring Y', type: 'torus',
      position: [0, 1.2, 0], rotation: [0, PI / 4, PI / 2], scale: [2, 2, 2],
      color: '#00aaff', roughness: 0, metalness: 1,
      emissive: '#00aaff', emissiveIntensity: 0.9,
      opacity: 0.85,
    },
  ],
  clips: [
...
export const FLOAT_DRIFT: SceneTemplate = {
  ...
  objects: [
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_fd_dodec', name: 'Center', type: 'dodecahedron',
      position: [0, 1.2, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
      color: '#c084fc', roughness: 0.3, metalness: 0.4,
      emissive: '#7e22ce', emissiveIntensity: 0.1,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_fd_s1', name: 'Sphere A', type: 'sphere',
      position: [-2, 1.5, -1], rotation: [0, 0, 0], scale: [0.7, 0.7, 0.7],
      color: '#86efac', roughness: 0.4, metalness: 0.2,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_fd_s2', name: 'Sphere B', type: 'sphere',
      position: [2, 0.8, 1], rotation: [0, 0, 0], scale: [0.6, 0.6, 0.6],
      color: '#93c5fd', roughness: 0.4, metalness: 0.2,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_fd_s3', name: 'Sphere C', type: 'sphere',
      position: [0.5, 2, 2.2], rotation: [0, 0, 0], scale: [0.5, 0.5, 0.5],
      color: '#fda4af', roughness: 0.4, metalness: 0.2,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_fd_cone', name: 'Cone', type: 'cone',
      position: [-1.5, 0.8, 2], rotation: [0, 0, 0], scale: [0.7, 1.2, 0.7],
      color: '#fde68a', roughness: 0.35, metalness: 0.15,
    },
  ],
  clips: [
    {
...
export const GEO_SPIN: SceneTemplate = {
  ...
  settings: {
    ...
    directionalPosition: [5, 10, 3],
    showGrid: true,
  },
  objects: [
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_gs_floor', name: 'Floor', type: 'plane',
      position: [0, -0.01, 0], rotation: [-PI / 2, 0, 0], scale: [10, 10, 1],
      color: '#111118', roughness: 0.8, metalness: 0.3,
      castShadow: false, receiveShadow: true,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_gs_ico', name: 'Icosahedron', type: 'icosahedron',
      position: [0, 1.2, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
      color: '#e2e8f0', roughness: 0.05, metalness: 1,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_gs_knot', name: 'Knot', type: 'torusKnot',
      position: [-2.5, 1, 0], rotation: [0, 0, 0], scale: [0.65, 0.65, 0.65],
      color: '#f97316', roughness: 0.1, metalness: 0.9,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_gs_dodec', name: 'Dodecahedron', type: 'dodecahedron',
      position: [2.5, 1, 0], rotation: [0, 0, 0], scale: [0.8, 0.8, 0.8],
      color: '#22d3ee', roughness: 0.05, metalness: 0.95,
    },
    {
      ...OBJECT_DEFAULTS,
      id: 'tpl_gs_ring', name: 'Ring', type: 'ring',
      position: [0, 1.2, 2.5], rotation: [0, 0, 0], scale: [1.2, 1.2, 0.05],
      color: '#a3e635', roughness: 0.1, metalness: 0.9,
    },
  ],
  clips: [
    {
...
export const EMPTY_STAGE: SceneTemplate = {
  ...
  objects: [
    {
      ...OBJECT_DEFAULTS,
      id: 'stage_floor', name: 'Floor', type: 'plane',
      position: [0, -0.01, 0], rotation: [-PI / 2, 0, 0], scale: [8, 8, 1],
      color: '#cccccc', roughness: 0.9, metalness: 0,
      castShadow: false, receiveShadow: true,
    },
  ],
  clips: [],
...
// ─── All templates (order matters for UI) ─────────────────────────────────────
